$(document).ready(function () {
    $('#terms').click(function (event) {
        ...
        $('#terms-content').load('terms', function (response, status, xhr) {
            if(status == 'error'){
                $('#terms-content').append('<i class="fa fa-times"><p>Se ha producido un error ' + xhr.status + '</p></i>');
            }
    ...
    $('#about').click(function (event) {
        ...
        $('#about-content').load('about', function (response, status, xhr) {
            if(status == 'error'){
                $('#about-content').append('<i class="fa fa-times"><p>Se ha producido un error ' + xhr.status + '</p></i>');
            }
    ...
    $('#privacy').click(function (event) {
        ...
        $('#privacy-content').load('privacy', function (response, status, xhr) {
            if(status == 'error'){
                $('#privacy-content').append('<i class="fa fa-times"><p>Se ha producido un error ' + xhr.status + '</p></i>');
            }
